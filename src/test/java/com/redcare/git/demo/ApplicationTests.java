...
class ApplicationTests {
	...
	void calculatePopularityScore_Success() throws Exception {
		...
		var request = new ObjectMapper().readValue(resource.getInputStream(), GitPopularityRequest.class);
	...
	@Test
	void calculatePopularityScore_ErrorDataParsing() throws Exception {
